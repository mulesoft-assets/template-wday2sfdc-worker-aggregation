...
public class WorkerMergeAggregationStrategy implements AggregationStrategy {
	...
	public MuleEvent aggregate(AggregationContext context) throws MuleException {
		...
		WorkersAndUsersMerge workersUsersMerge = new WorkersAndUsersMerge();
		List<Map<String, String>> mergedAccountList = workersUsersMerge.mergeList(listA, listB);
